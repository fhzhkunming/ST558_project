...
- [kableExtra: ](https://cran.r-project.org/web/packages/kableExtra/index.html) A package for building complex HTML or 'LaTeX' tables.  
...
### A function to query median salaries of different jobs from 50 countries   
```{r}
...
### A function to query median salaries of first tier cities worldwide
```{r}
...
### A function to query life quality scores of state capital cities in the US  
```{r, results='hide'}
...
### Function to display summary of selected city
...
kable(us_city_table)
```
### Function to display summary of city of your choose  
...
#### Compare life quality scores for US cities that available in the Teleport API
```{r}
...
```
### A contingency table showing high-paying and non-high-paying jobs
...
### Visulization of median salary of 52 cities 
...
```  
#### The bottom low-paying jobs in the first tier cities in the world  
```{r}
...
### Graphs showing different life quality scores of US cities
...
### A function showing life quality in 18 US state capital cities.  
